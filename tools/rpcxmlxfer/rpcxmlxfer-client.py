...
__rcsid__ = "$Id: rpcxmlxfer-client.py 1915 2005-08-26 12:58:38Z md $"
...
parser = OptionParser(usage=usage, version='$Rev: 1915 $')
...
if options.verbose > 2:
  print "rpcxmlxfer-client $Rev: 1915 $ started."
  print options
...
if options.getserverdoc:
  ...
  session, motd = server.init_session(options.userid, options.sensorid,
                                      ...
                                      {'clientsoftware': 'rpcxmlxfer-client $Rev: 1915 $'})
  endtask(session)
  if verbose:
