...
/**
 * The Constructor
 * creates a new VERITASVuln Module, 
 * VERITASVuln is an example for binding a socket & setting up the Dialogue & DialogueFactory
 * 
 * 
 ...
 * 
 * creates a new VERITASVulnDialogue
 * 
 ...
 */
Dialogue *VERITASVuln::createDialogue(Socket *socket)
{
	return new VERITASDialogue(socket);
}
