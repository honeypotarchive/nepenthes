...
/* $Id: VFSCommandRREDIR.cpp 1947 2005-09-08 17:30:06Z common $ */ 
...
VFSCommandRREDIR::VFSCommandRREDIR(VFSNode *parent,VFS *vfs)
{
	m_Name =	">>";
	m_ParentNode = parent;
	m_Type = VFS_EXE;
...
VFSCommandRREDIR::~VFSCommandRREDIR()
{

} 

int32_t VFSCommandRREDIR::run(vector<string> *paramlist)
{
...
/*	list <string> slist = *paramlist;
	...
	{
		logInfo("RREDIR dest '%s' \n",(*it).c_str());
	}
	logInfo("RREDIR Content %s\n",m_VFS->getStdOut().c_str());
	*ret = "";
*/
	return 0;
}
