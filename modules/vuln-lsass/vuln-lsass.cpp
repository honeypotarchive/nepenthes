...
/**
 * The Constructor
 * creates a new LSASSVuln Module, 
 * LSASSVuln is an example for binding a socket & setting up the Dialogue & DialogueFactory
 * 
 * 
 ...
 */
LSASSVuln::LSASSVuln(Nepenthes *nepenthes)
{
	...
	m_DialogueFactoryDescription = "creates dialogues to emulate lsass";
 ...
 * 
 * creates a new LSASSVulnDialogue
 * 
 ...
 */
Dialogue *LSASSVuln::createDialogue(Socket *socket)
{
	return new LSASSDialogue(socket);
}
