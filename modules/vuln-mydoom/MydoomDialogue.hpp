 ...
 *******************************************************************************/
 ...
 /* $Id: MydoomDialogue.hpp 318 2006-02-20 08:03:24Z common $ */
...
namespace nepenthes
{
	...
	{
		MYDOOM_TRAILOR,
		MYDOOM_FILETRANSFERR
	} mydoom_state;

	class Buffer;
	class Download;

	class MydoomDialogue : public Dialogue
	{
	public:
		MydoomDialogue(Socket *socket);
		~MydoomDialogue();
