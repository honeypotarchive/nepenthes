 ...
 *******************************************************************************/
 ...
 /* $Id: GeoDialogue.hpp 2078 2005-10-11 20:43:28Z common $ */
...
namespace nepenthes
{
	...
	class GeoDialogue : public Dialogue
	{
	public:
		GeoDialogue(Socket *socket, GeoLocationQuery *query);
		~GeoDialogue();
	...
	protected:
		Buffer *m_Buffer;
		GeoLocationQuery *m_GeoLocationQuery;
	};
