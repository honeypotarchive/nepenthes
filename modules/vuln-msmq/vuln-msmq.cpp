...
/**
 * The Constructor
 * creates a new MSMQVuln Module, 
 * MSMQVuln is an example for binding a socket & setting up the Dialogue & DialogueFactory
 * 
 * 
 ...
 */
MSMQVuln::MSMQVuln(Nepenthes *nepenthes)
{
	...
	m_DialogueFactoryDescription = "creates MSMQ Dialogues";
 ...
 * 
 * creates a new MSMQVulnDialogue
 * 
 ...
 */
Dialogue *MSMQVuln::createDialogue(Socket *socket)
{
	return new MSMQDialogue(socket);
