 ...
 *******************************************************************************/
 ...
 /* $Id: vuln-upnp.cpp 1644 2005-07-14 16:19:15Z dp $ */
...
/**
 * The Constructor
 * creates a new UPNPVuln Module, 
 * UPNPVuln is an example for binding a socket & setting up the Dialogue & DialogueFactory
 * 
 * 
 ...
 */
UPNPVuln::UPNPVuln(Nepenthes *nepenthes)
{
 ...
 * 
 * creates a new UPNPVulnDialogue
 * 
 ...
 */
Dialogue *UPNPVuln::createDialogue(Socket *socket)
{
	return new UPNPDialogue(socket);
