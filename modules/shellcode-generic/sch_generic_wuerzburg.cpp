 ...
 *******************************************************************************/
 ...
 /* $Id: sch_generic_wuerzburg.cpp 1733 2005-08-01 10:23:55Z common $ */
...
sch_result Wuerzburg::handleShellcode(Message **msg)
{
	...
	if ((matchCount = pcre_exec(m_wuerzburgPattern, 0, (char *) shellcode, len, 0, 0, ovec, sizeof(ovec)/sizeof(int))) > 0)
	{
