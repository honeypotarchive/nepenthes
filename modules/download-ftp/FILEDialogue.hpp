 ...
 *******************************************************************************/
 ...
 /* $Id: FILEDialogue.hpp 318 2006-02-20 08:03:24Z common $ */
...
namespace nepenthes
{
	...
	class FILEDialogue : public Dialogue
	{
	public:
		FILEDialogue(Socket *socket, Download *down, CTRLDialogue *dia);
		~FILEDialogue();
